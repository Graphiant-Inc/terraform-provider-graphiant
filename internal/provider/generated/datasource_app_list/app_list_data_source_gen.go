...
func AppListDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"apps": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.Int64Attribute{
							...
							MarkdownDescription: "Identifier of the referenced app.",
						},
						"type": schema.StringAttribute{
							Computed:            true,
							Description:         "Type discriminator for the referenced app (e.g. \"custom\", \"graphiant\", \"app-list\").",
							MarkdownDescription: "Type discriminator for the referenced app (e.g. \"custom\", \"graphiant\", \"app-list\").",
						},
					},
					CustomType: AppsType{
				...
				MarkdownDescription: "Apps included in this app list.",
			},
			"description": schema.StringAttribute{
				Computed:            true,
				Description:         "Free-form description of the app list.",
				MarkdownDescription: "Free-form description of the app list.",
			},
			"id": schema.Int64Attribute{
				Required: true,
			},
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "App list name.",
			},
		},
	}
}
...
type AppsValue struct {
	...
	AppsType basetypes.StringValue `tfsdk:"type"`
...
func (v AppsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	case attr.ValueStateKnown:
		...
		val, err = v.AppsType.ToTerraformValue(ctx)
...
func (v AppsValue) Equal(o attr.Value) bool {
	...
	if !v.AppsType.Equal(other.AppsType) {
		return false
	}
